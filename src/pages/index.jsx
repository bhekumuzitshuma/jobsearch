          ...
          <div className="space-y-6">
            <div>
              ...
              <input
                ...
                className="mt-1 block w-full text-gray-800 rounded-md border border-gray-300 px-3 py-2 shadow-sm focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500"
              />
            </div>
            <div>
              <label
